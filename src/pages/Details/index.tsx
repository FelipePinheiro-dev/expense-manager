...
const columns: ColumnDef<TypeData>[] = [
...

  {
    ...
    header: 'Title',
    cell: (props) => (
      <CellInputUpdate type="text" cell={props} table={props.table} />
    ),
...

  {
    ...
    header: 'Category',
    cell: (props) => (
      <CellMenuUpdate cell={props} table={props.table} items={CATEGORIES} />
    ),
    enableColumnFilter: true,
...

  {
    ...
    header: 'Type',
    cell: (props) => (
      <CellMenuUpdate cell={props} table={props.table} items={TRANSACTIONS} />
    ),
  },

  {
    ...
    header: 'Value',
    cell: (props) => (
      <CellInputUpdate type="number" cell={props} table={props.table} />
    ),
  },

  {
    accessorKey: 'date',
    header: 'Date',
    cell: (props) => <CellDateUpdate cell={props} table={props.table} />,
  },
]
