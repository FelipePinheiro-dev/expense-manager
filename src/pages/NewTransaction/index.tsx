...
const schemaFormTransaction = zod.object({
  title: zod
    ...
    .regex(
      /^[A-Z][a-z]*(\s[A-Z][a-z]*)*$/,
      'First letter must be capitalized and the rest lowercase',
    ),
...
export function NewTransaction() {
  ...
  const { register, handleSubmit, control, setValue, reset } = methodsForm
  ...
  return (
    <NewTransactionContainer>
      <NewTransactionContent>
        ...
        <form
          onSubmit={handleSubmit(onSubmit, (errors) => errorHandling(errors))}
        >
          <FormControl>
            <InputLabel htmlFor="title">Title</InputLabel>
            <OutlinedInput id="title" label="Title" {...register('title')} />
          </FormControl>
              ...
              <FormControl>
                ...
                >
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <Radio
                        sx={{ '&.Mui-checked': { color: colors.red[500] } }}
                      />
                    }
                  />
                </RadioGroup>
